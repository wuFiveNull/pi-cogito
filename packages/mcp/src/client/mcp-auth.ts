...
/** Local equivalent of the adapter's resolveConfiguredOAuthDir (kept dependency-free). */
function resolveConfiguredOAuthDir(raw: unknown, cwd = process.cwd()): string | undefined {
