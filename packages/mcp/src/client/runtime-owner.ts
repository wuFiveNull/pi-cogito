/** Minimal UI surface (subset of the pi ExtensionUIContext; same call shapes). */
...
export function createOwnedUi<T extends ExtensionUIContext>(ui: T, owner: McpRuntimeOwner): T {
