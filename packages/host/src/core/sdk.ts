...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@cogito/agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@cogito/ai/compat";
 ...
 *
 * // With explicit model
 * import { getModel } from '@cogito/ai';
 * const { session } = await createAgentSession({
