...
export const PACKAGE_NAME: string = pkg.name || "@cogito/host";
export const APP_NAME: string = piConfigName || "cogito";
export const APP_TITLE: string = piConfigName ? APP_NAME : "Cogito";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".cogito";
...
// =============================================================================
// User Config Paths (~/.cogito/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.cogito/agent/) */
