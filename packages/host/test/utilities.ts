...
import type { OAuthCredentials } from "@cogito/ai";
import { getModel, streamSimple } from "@cogito/ai/compat";
import { builtinProviders } from "@cogito/ai/providers/all";
...
// ============================================================================
// OAuth API key resolution from ~/.cogito/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".cogito", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.cogito/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.cogito/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".cogito", "agent");

/**
 * Get an AuthStorage instance backed by ~/.cogito/agent/auth.json
