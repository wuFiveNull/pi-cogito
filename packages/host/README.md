...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@cogito/coding-agent"><img alt="npm" src="https://img.shields.io/npm/v/@cogito/coding-agent?style=flat-square" /></a>
</p>
...
```bash
npm install -g --ignore-scripts @cogito/coding-agent
```
...
```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "@cogito/coding-agent";
...
- [@cogito/ai](https://www.npmjs.com/package/@cogito/ai): Core LLM toolkit
- [@cogito/agent-core](https://www.npmjs.com/package/@cogito/agent-core): Agent framework
- [@cogito/tui](https://www.npmjs.com/package/@cogito/tui): Terminal UI components
